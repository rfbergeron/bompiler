...
SRC = debug.c bcc_err.c attributes.c strset.c lyutils.c astree.c symtable.c tchk_common.c tchk_expr.c tchk_stmt.c tchk_decl.c asmgen.c state.c main.c
HDR = debug.h bcc_err.h attributes.h strset.h lyutils.h astree.h symtable.h tchk_common.h tchk_expr.h tchk_stmt.h tchk_decl.h asmgen.h state.h simplestack.h
OBJ = ${SRC:.c=.o}
