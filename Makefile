...
EXECNAME = bompiler
# .c source files
SRC = debug.c attributes.c strset.c lyutils.c astree.c symval.c typecheck.c main.c
# .h header files
HDR = debug.h attributes.h strset.h lyutils.h astree.h symval.h typecheck.h simplestack.h
