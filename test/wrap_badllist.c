...
int __wrap_llist_init(LinkedList *list, BlibDestroyer dest,
                      BlibComparator comp) {
  return mock_type(int);
}
int __wrap_llist_destroy(LinkedList *list) { return mock_type(int); }
/* int __wrap_llist_copy(LinkedList *dest, const LinkedList *src); */
int __wrap_llist_push_front(LinkedList *list, void *element) {
  return mock_type(int);
}
void *__wrap_llist_pop_front(LinkedList *list) { return mock_ptr_type(void *); }
...
void *__wrap_llist_pop_back(LinkedList *list) { return mock_ptr_type(void *); }
...
size_t __wrap_llist_size(const LinkedList *list) { return mock_type(size_t); }
int __wrap_llist_empty(const LinkedList *list) { return mock_type(int); }
int __wrap_llist_status(const LinkedList *list) { return mock_type(int); }
